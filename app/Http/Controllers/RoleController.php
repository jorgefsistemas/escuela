...
class RoleController extends Controller
{
    ...
    {
        $user_roles= User::where('id', '!=' , 1)->with('permissions')->get();
    ...
    public function show($id)
    {
        ...
        $rolePermissions = Permission::orderBy('id','DESC')->join("role_has_permissions","role_has_permissions.permission_id","=","permissions.id")
        ->where("role_has_permissions.role_id",$id)->paginate(5);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('roles.index')->with('success','Role eliminado con exito');
            ...
            //throw $th;
            return redirect()->route('roles.index')->with('warning','Falla al Eliminar el Rol');

        }
        return redirect()->route('roles.index')->with('info','Lista de roles');
    }
